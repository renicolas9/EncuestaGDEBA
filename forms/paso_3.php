<div class="paso" id="paso-3">
		...
		<div class="paso-inputs xl">
					...
					<div>
						<div>
							...
							<div class="options-right xl">
								<label class="container-checkbox"><input type="checkbox" name="limitantes" value="0-5"/> <span class="checkmark-checkbox"></span> <span class="text-checkbox small">Imposibilidad de realizar un pase de varios expedientes -al mismo tiempo- a un mismo usuario/sector.</span></label>
			...
			<div class="section-input" id="module-gedo" style="display: none;">
				...
				<div>
					<div>
						<div>
							<div class="options-left xl">
								<label class="container-checkbox"><input type="checkbox" name="limitantes" value="0-5"/> <span class="checkmark-checkbox"></span> <span class="text-checkbox small">Inexistencia de la función “autoguardado” en la producción de un documento. </span></label>
								<label class="container-checkbox"><input type="checkbox" name="limitantes" value="6-10"/> <span class="checkmark-checkbox"></span> <span class="text-checkbox small">No se puede visualizar, sin descargar, un archivo embebido a un GEDO.</span></label>
								<label class="container-checkbox"><input type="checkbox" name="limitantes" value="11-15"/> <span class="checkmark-checkbox"></span> <span class="text-checkbox small">El sistema no alerta en caso de no haber tildado la opción “Quiero recibir un aviso cuando el documento se firme”.</span></label>
							</div>
			...
			<div class="section-input">
				<label class="subtitle-2">.Generales</label>
				<div>
					<div>
						<div>
							<div class="options-left xl">
								<label class="container-checkbox"><input type="checkbox" name="limitantes" value="0-5"/> <span class="checkmark-checkbox"></span> <span class="text-checkbox small">No es posible asignar revisores de firma a documentos que no sean de firma conjunta.</span></label>
